    ...
    <div className="app-container">
      ...
      <section id="home" style={styles.heroSection}>
        ...
        >
          ...
          <motion.p variants={itemVariant} style={styles.heroText}>
            ...
            apparaten, problemen onderzoeken en oplossen. Ik hou ervan om
            gestructureerd te werk te gaan en een planning maken. Naast mijn
            technische kennis, hou ik ervan om een praatje te maken en te
            socializen.
          </motion.p>
      ...
      >
        ...
        >
          ...
          <h3 style={styles.contactInfo}>adam.redjimi@hva.nl</h3>
        </motion.div>
        <div style={styles.titleUnderline}></div>
        ...
        >
          <div style={styles.contactInfo}>
            ...
            <p style={{ color: "var(--text-muted)", marginBottom: "2rem" }}>
              Ik ben naast alle technische vaardigheden een sociaal persoon. Ik
              hou ook ervan om de verantwoordelijkheid te nemen om ervoor te
              zorgen dat het teamverband goed verloopt. Dus als je
              geinteresseerd bent in een samenwerking, neem dan contact op met
              mij.
            </p>
          </div>
        </motion.div>
